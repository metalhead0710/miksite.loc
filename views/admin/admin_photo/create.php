    ...
    <div class="tab-content">
      <div class="tab-pane fade active in" id="ua">
        ...
        <div class="form-group">
          ...
          <input class="form-control" required name="title" placeholder="SEO заголовок" type="text">
        </div>
        <div class="form-group">
          <label> Ключові слова </label>
          <input class="form-control" required name="keywords" placeholder="SEO ключові слова" type="text">
        </div>
        <div class="form-group">
          <label> Опис </label>
          <input class="form-control" required name="description" placeholder="SEO опис" type="text">
        </div>
      </div>
      <div class="tab-pane fade" id="ru">
        ...
        <div class="form-group">
          <label> Заголовок сторінки </label>
          <input class="form-control" required name="title_ru" placeholder="SEO заголовок  на русіше" type="text">
        </div>
        <div class="form-group">
          <label> Ключові слова </label>
          <input class="form-control" required name="keywords_ru" placeholder="SEO ключові слова на русіше" type="text">
        </div>
        <div class="form-group">
          <label> Опис </label>
          <input class="form-control" required name="description_ru" placeholder="SEO опис на русіше" type="text">
        </div>
      </div>
