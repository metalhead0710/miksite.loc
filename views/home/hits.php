...
<div class="main-content-block">
    ...
    <div class="container">
        ...
        <?php foreach ($hits as $hit) : ?>
          <div class="PlanPricing template4 col-md-4 col-sm-6 col-xs-12" data-id="<?= $hit['id'] ?>">
            <div class="planName">
            ...
            <div class="planFeatures">
              <ul>
                <li><img class="pic" src="/upload/images/hits/thumbs/<?= $hit['picture'] ?>"></li>
                <li>
                  <div class="specs"><?= ($_SESSION['lang'] == 'ua') ? $hit['specs'] : $hit['specs_ru'] ?></div>
                </li>
              </ul>
            </div>
            <p class="text-center">
              <a href="#modal" role="button" data-toggle="modal" data-id="<?= $hit['id'] ?>"
                                      class="btn btn-success btn-large order"><?= Dict::_('SORDER') ?>
              </a>
            </p>
          </div>
        <?php endforeach; ?>
